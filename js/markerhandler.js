...
AFRAME.registerComponent("markerhandler", {
  ...
  askUserId: function() {
    ...
    swal({
      ...
      content: {
        element: "input",
        attributes: {
          placeholder: "Type your uid , For example like this U01"
        }
      }
    }).then(inputValue => {
      orderId = inputValue;
  ...
  handleOrder: function(orderId, toy) {
    firebase.firestore().collection("users").doc(orderId).get().then(doc => {
